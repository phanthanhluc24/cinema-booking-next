...
export default function Login() {
    ...
    const handleFormSubmit=()=>{
        ...
        .then((data)=>{
            ...
            toast("Login successfully",{hideProgressBar:false,autoClose:3000,type:"success"})
            if (formRef.current) {
    ...
    <>
      <div className="mx-auto  bg-gray-900 h-screen">
        <div className="mx-auto w-2/3 flex justify-center">
              <Form ref={formRef} onFinish={handleFormSubmit} className='shadow-xl rounded-lg bg-gray-300 mt-32 w-96'>
                <div className="p-5">
                <div className="mb-4">
                  <label htmlFor="" className="block text-gray-600 font-bold text-xl">
                    Email
                  </label>
                  <Form.Item
                    name="email"
                ...
                <span>Don't have an account? <Link className="hover:text-blue-600" href={"/auth/register"}>
                      Create account
                    </Link></span>
                </div>
                </div>
